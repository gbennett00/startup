  ...
  return (
    <main>
      <div class="text-center">
          ...
          <p class="py-3">I'm a student at BYU studying software engineering. I've played a game similar to this one with my family and decided to make it an online game for a class.</p>
          <div id="quote" class="quote-box text-dark">
